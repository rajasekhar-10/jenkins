pipeline {
   ...
   environment {
     ...
     color = "Blank"
     // These credentials would have been configured in Jenkins 
     // with their respective credential IDs AWS-ACK and AWS-SCK
   ...
   stages {
      ...
      stage('AWS Fetch') {
         steps {
            // AWS IAM Credentials
            withCredentials([string(credentialsId: 'AWS-ACK', variable: 'AWS-ACK-VAR'), string(credentialsId: 'AWS-SCK', variable: 'AWS-SCK-VAR')]) {
